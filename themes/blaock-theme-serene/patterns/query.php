...
/**
 * Title: Query
 * Slug: blaock-theme-serene/query
 * Categories: posts
...
<div class="wp-block-query">
	<!-- wp:post-template -->
		...
		<!-- wp:pattern {"slug":"blaock-theme-serene/hidden-post-meta"} /-->
	...
	<!-- /wp:post-template -->
	<!-- wp:query-no-results -->
	<!-- wp:paragraph --><p><?php esc_html_e( 'No results found.', 'blaock-theme-serene'); ?></p><!-- /wp:paragraph -->
	<!-- /wp:query-no-results -->
